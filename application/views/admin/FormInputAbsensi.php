...
<div class="container-fluid">
    ...
    <form method="POST">
        ...
        <table class="table table-bordered table-striped">
            ...
            <?php $no = 1;
            foreach ($Input_Absensi as $z) : ?>
                <tr>
                    <input type="hidden" name="bulan[]" class="form-control" value="<?php echo $bulantahun ?>">
                    <input type="hidden" name="nik[]" class="form-control" value="<?php echo $z->nik ?>">
                    <input type="hidden" name="nama_pegawai[]" class="form-control" value="<?php echo $z->nama_pegawai ?>">
                    <input type="hidden" name="jenis_kelamin[]" class="form-control" value="<?php echo $z->jenis_kelamin ?>">
                    <input type="hidden" name="nama_jabatan[]" class="form-control" value="<?php echo $z->nama_jabatan ?>">


                    <td><?php echo $no++ ?></td>
                    <td><?php echo $z->nik ?></td>
                    <td><?php echo $z->nama_pegawai ?></td>
                    <td><?php echo $z->jenis_kelamin ?></td>
                    <td><?php echo $z->nama_jabatan ?></td>
