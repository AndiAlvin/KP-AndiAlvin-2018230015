<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('manajer/DataGaji') ?>">
                    <i class="fas fa-fw fa-money-check-alt"></i>
                    <span>Data Gaji</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('manajer/DataPegawai') ?>">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('manajer/GantiPassword') ?>">
                    <i class="fas fa-fw fa-user-lock"></i>
                    <span>Ganti Password</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('manajer/jam') ?>">
                    <i class="fas fa-business-time"></i> <span>jam</span></a>
            </li>
            <li class="nav-item <?= @$_active ?>">
                <a class="nav-link" href="<?= base_url('manajer/absensi/check_absen') ?>">
            ...
            <li class="nav-item <?= @$_active ?>">
                <a class="nav-link" href="<?= base_url('manajer/absensi/list_karyawan') ?>">
                    <i class="fas fa-user-tie"></i>
                    <span>Cek Absen Pegawai</span> </a>
            </li>
