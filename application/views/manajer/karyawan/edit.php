<div class="row">
    <div class="col-12">
        <div class="card">
            <form action="<?= base_url('manajer/karyawan/update') ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id_pegawai" value="<?= $this->uri->segment(3) ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="divisi" id="divisi" value="<?= $karyawan->divisi ?>" class="form-control">
                                ...
                                <?php foreach ($divisi as $d) : ?>
                                    <option value="<?= $d->id_jabatan ?>" <?= ($d->id_jabatan == $karyawan->data_jabatan) ? 'selected' : '' ?>><?= $d->nama_jabatan ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
