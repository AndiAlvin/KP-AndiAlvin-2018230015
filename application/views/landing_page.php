         ...
         <div class="container">
            ...
            <div class="collapse_menu deactive">
               ...
               <ul class="nav">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="<?php echo base_url('login'); ?>">Penggajian</a>
                  </li>
               </ul>
            </div>
         </div>
   ...
   <div class="Team" id="AboutMe">
      <div class="Section">
         <div class="text-center">
            <h2>About Me</h2>
            <div class="subHeading">
               Website ini dibuat oleh Andi Alvin diajukan untuk kelulusan Mata Kuliah Kerja Praktek
            </div>
            <br>
         </div>
         <div class="content">
            <div class="team row">
               <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                  <div class="card">
                     <div class="TopImg">
                        <img src="<?php echo base_url(); ?>assets/photo/Alvin.jpg" class="rounded-circle w-100 d-block">
                     </div>
                     <div class="TeamInfo text-center">
                        <div class="Name">Andi Alvin</div>
                        <div class="Job">Mahasiswa</div>
                        <div class="social_links">
                           <div class="social">
                              <a class="" href="https://www.instagram.com/idnanivla/"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-12 text-center my-3">
               Copyright &copy; Andi Alvin | Penggajian 2021 - All Rights Reserved
            </div>
         </div>
      </div>
   </div>
